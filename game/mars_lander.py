...
class MarsLander(gym.Env):
    ...
    def __init__(self, level=1):
        ...
        self.satelit_pic_path = os.path.join('.', 'img_group_1',
                                             'satellite.png')
        self.station_pic_path = os.path.join('.', 'img_group_1',
                                             'station_1.png')
        self.asteroid_pic_path = os.path.join('.', 'img_group_1',
                                              'asteroid.png')
        self.blackhole_pic_path = os.path.join('.', 'img_group_1',
                                               'blackhole.png')
    ...
    def step(self, p_action):
        ...
        if (sum(self.last_rewards) >= (10 * REWARD)):
            print('\x1b[6;30;42m' + 'Success! You solved the mars' +
                  'landing problem within {} '.format(self.reset_counter) + '\x1b[0m')
                  # + 'episodes'
